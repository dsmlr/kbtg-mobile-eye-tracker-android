...
class NotificationHelper constructor(context: Context) : ContextWrapper(context) {
    ...
    companion object {
        ...
        const val MESSAGE_NOTIFICATION_CHANNEL = "com.ria.demo.utilities.message_channel"
        const val COMMENT_NOTIFICATION_CHANNEL = "com.ria.demo.utilities.comment_channel"
